...
export function getCommodities() {
  return [
    { name: "Base and Rare Metals", code: 1 },
    { name: "Non-nuclear Fuel Minerals", code: 1 },
    { name: "Precious Metals", code: 1 },
    { name: "Precious Stones", code: 1 },
    { name: "Semi-Precious Stones", code: 1 },
    { name: "Dimension Stone", code: 1 },
    { name: "Indestrual minerals", code: 1 },
    { name: "Nuclear Fuel minerals", code: 1 },
    { name: "Oil" },
    { name: "Gas" }
  ];
}
